...
#Not orignaly included in API:
OAK_STAIRS          = Block(59)
SIGN                = Block(63)
WALL_SIGN           = Block(68)
GLOWING_REDSTONE_ORE = Block(74)
NETHERRACK          = Block(87)
TRAPDOOR            = Block(96)
MELON_SEEDS         = Block(105)
...
UPDATE_GAME_BLOCK1  = Block(248)
UPDATE_GAME_BLOCK2  = Block(249)
INFO_RESERVED6      = Block(255)
